...
<body>
  ...
  <p><b>PHP</b> adalah script untuk pemrograman script web server-side, script yang membuat dokumen <b>HTML</b> secara
    on the fly, dokumen <b>HTML</b> yang dihasilkan dari suatu aplikasi bukan dokumen <b>HTML</b> yang dibuat dengan
    menggunakan editor teks
    atau editor <b>HTML</b>.</p>​
  <p>Dengan menggunakan <b>PHP</b> maka maintenance suatu situs web menjadi lebih mudah. Proses update data dapat
    dilakukan dengan menggunakan aplikasi yang dibuat dengan menggunakan script <b>PHP</b>.​</p>
  <p><b>PHP/FI</b> merupakan nama awal dari <b>PHP</b>. <b>PHP</b> merupakan singkatan dari Personal Home Page dan FI
    adalah singkatan dari Form Interface. Dibuat pertama kali oleh Rasmus Lerdoff. <b>PHP</b>, awalnya merupakan program
    CGI yang dikhususkan
    untuk menerima input melalui form yang ditampilkan dalam browser web.</p>
    ...
    <div style="font-size: 17px; margin-left: 200px;">
      <?php
        // tugas 3
            ...
            define("Judul", "Hitung Keliling Persegi Panjang");
            #komentar untuk nilai Rumus
            define("Rumus", 2);
            echo Judul;
            $p = 12;
            $l = 8;
            ...
            echo "Lebar: $l<br>";
            $keliling = Rumus * ($p + $l);
            echo "Keliling Persegi Panjang: $keliling<br><br>";

            //konstanta untuk nilai judul
            define("Judul2", "Hitung Luas Segi Tiga");
            #komentar untuk nilai Rumus2
            define("Rumus2", 0.5);
            echo Judul2;
            $a = 15;
            $t = 5;
      ...
      <div class="container" style="height: 700px;"></div>
    </div>
  </div>
</body>
